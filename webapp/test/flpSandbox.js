		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Set Number Creat",
									"targetURL": "#ysetnumbercreation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ysetnumbercreation-display": {
								"semanticObject": "ysetnumbercreation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ysetnumbercreation",
									"url": sap.ui.require.toUrl("ysetnumbercreation")
								}
							}
						}
					}
